...
public class LabyrinthLostWatcher
extends Fighter {
    public LabyrinthLostWatcher(NpcInstance npcInstance) {
        super(npcInstance);
    }
    ...
    protected void onEvtDead(Creature creature) {
        ...
        if (!reflection.isDefault() && this.a(npcInstance.getNpcId()) && this.a() != null) {
            this.a().addStatFunc((Func)new FuncSet(Stats.POWER_DEFENCE, 48, (Object)this, (double)this.a().getTemplate().basePDef * 0.66));
        }
