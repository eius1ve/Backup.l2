...
extends DefaultAI {
    ...
    protected boolean thinkActive() {
        ...
        if (l > this.n && (this.F > -1 || Rnd.chance((int)5))) {
            if (!this.k) {
                switch (this.F) {
                    case 0: 
                    case 8: {
            ...
            this.addTaskMove(a[this.F], false);
            this.doTask();
            return true;
        }
