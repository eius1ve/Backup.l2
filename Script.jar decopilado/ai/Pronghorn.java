...
public class Pronghorn
extends Fighter {
    private static final int ae = 22087;
    private static final int af = 4;
    private boolean p;

    public Pronghorn(NpcInstance npcInstance) {
        super(npcInstance);
    }
    ...
    protected void onEvtSeeSpell(Skill skill, Creature creature) {
        ...
        if (this.p) {
            ...
            for (int i = 0; i < 4; ++i) {
                try {
                    NpcInstance npcInstance2 = NpcUtils.spawnSingle((int)22087, (Location)Location.findPointToStay((GameObject)npcInstance, (int)100, (int)120), (Reflection)npcInstance.getReflection());
