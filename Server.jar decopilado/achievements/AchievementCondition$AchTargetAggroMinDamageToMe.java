...
@AchievementCondition.AchievementConditionName(value="target_npc_min_damage_to_me")
public static class AchievementCondition.AchTargetAggroMinDamageToMe
extends AchievementCondition {
    private final int f;

    public AchievementCondition.AchTargetAggroMinDamageToMe(String string) {
