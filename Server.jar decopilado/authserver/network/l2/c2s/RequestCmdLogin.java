...
public class RequestCmdLogin
extends L2LoginClientPacket {
    private static final Logger a = Logger.getLogger(RequestCmdLogin.class.getName());
    private byte[] e;
    private int dL;
    ...
    protected void runImpl() throws Exception {
        ...
        try {
            ...
            ((Cipher)object).doFinal(this.e, 0, 128, byArray, 0);
        }
        catch (GeneralSecurityException generalSecurityException) {
            a.log(Level.INFO, "", generalSecurityException);
            return;
        }
        try {
            object = new String(byArray, 64, 14).trim();
            string = new String(byArray, 96, 16).trim();
        }
