...
public class PrintfFormat {
    private List<ConversionSpecification> V = new ArrayList<ConversionSpecification>();
    private int ex = 0;
    private DecimalFormatSymbols a = null;
    ...
    public PrintfFormat(Locale locale, String string) throws IllegalArgumentException {
        ...
        String string2 = this.a(string, 0);
        if (string2 != null) {
            conversionSpecification = new ConversionSpecification();
            conversionSpecification.setLiteral(string2);
            this.V.add(conversionSpecification);
        }
        while (this.ex != -1 && this.ex < string.length()) {
            for (n = this.ex + 1; n < string.length(); ++n) {
                char c = '\u0000';
                c = string.charAt(n);
                if (c == 'i' || c == 'd' || c == 'f' || c == 'g' || c == 'G' || c == 'o' || c == 'x' || c == 'X' || c == 'e' || c == 'E' || c == 'c' || c == 's' || c == '%') break;
            }
            n = Math.min(n + 1, string.length());
            conversionSpecification = new ConversionSpecification(string.substring(this.ex, n));
            this.V.add(conversionSpecification);
            string2 = this.a(string, n);
    ...
    private String a(String string, int n) {
        this.ex = string.indexOf("%", n);
        if (this.ex == -1) {
            this.ex = string.length();
        }
        return string.substring(n, this.ex);
    }
    ...
    public String sprintf(Object ... objectArray) {
        ...
        for (ConversionSpecification conversionSpecification : this.V) {
            c = conversionSpecification.getConversionCharacter();
            if (c == '\u0000') {
                stringBuilder.append(conversionSpecification.getLiteral());
                continue;
            }
            if (c == '%') {
            ...
            if (objectArray[n] instanceof Byte) {
                stringBuilder.append(conversionSpecification.internalsprintf(((Byte)objectArray[n]).byteValue()));
            } else if (objectArray[n] instanceof Short) {
                stringBuilder.append(conversionSpecification.internalsprintf(((Short)objectArray[n]).shortValue()));
            } else if (objectArray[n] instanceof Integer) {
                stringBuilder.append(conversionSpecification.internalsprintf((Integer)objectArray[n]));
            } else if (objectArray[n] instanceof Long) {
                stringBuilder.append(conversionSpecification.internalsprintf((Long)objectArray[n]));
            } else if (objectArray[n] instanceof Float) {
                stringBuilder.append(conversionSpecification.internalsprintf(((Float)objectArray[n]).floatValue()));
            } else if (objectArray[n] instanceof Double) {
                stringBuilder.append(conversionSpecification.internalsprintf((Double)objectArray[n]));
            } else if (objectArray[n] instanceof Character) {
                stringBuilder.append(conversionSpecification.internalsprintf(((Character)objectArray[n]).charValue()));
            } else if (objectArray[n] instanceof String) {
                stringBuilder.append(conversionSpecification.internalsprintf((String)objectArray[n]));
            } else {
                stringBuilder.append(conversionSpecification.internalsprintf(objectArray[n]));
            }
    ...
    public String sprintf(int n) throws IllegalArgumentException {
        ...
        for (ConversionSpecification conversionSpecification : this.V) {
            ...
            stringBuilder.append(conversionSpecification.internalsprintf(n));
        }
        return stringBuilder.toString();
    }
    ...
    public String sprintf(long l) throws IllegalArgumentException {
        ...
        for (ConversionSpecification conversionSpecification : this.V) {
            ...
            stringBuilder.append(conversionSpecification.internalsprintf(l));
        }
        return stringBuilder.toString();
    }
    ...
    public String sprintf(double d) throws IllegalArgumentException {
        ...
        for (ConversionSpecification conversionSpecification : this.V) {
            ...
            stringBuilder.append(conversionSpecification.internalsprintf(d));
        }
        return stringBuilder.toString();
    }
    ...
    public String sprintf(String string) throws IllegalArgumentException {
        ...
        for (ConversionSpecification conversionSpecification : this.V) {
            ...
            stringBuilder.append(conversionSpecification.internalsprintf(string));
        }
        return stringBuilder.toString();
    }
    ...
    public String sprintf(Object object) throws IllegalArgumentException {
        ...
        for (ConversionSpecification conversionSpecification : this.V) {
            ...
            if (object instanceof Byte) {
                stringBuilder.append(conversionSpecification.internalsprintf(((Byte)object).byteValue()));
                continue;
            }
            if (object instanceof Short) {
                stringBuilder.append(conversionSpecification.internalsprintf(((Short)object).shortValue()));
                continue;
            }
            if (object instanceof Integer) {
                stringBuilder.append(conversionSpecification.internalsprintf((Integer)object));
                continue;
            }
            if (object instanceof Long) {
                stringBuilder.append(conversionSpecification.internalsprintf((Long)object));
                continue;
            }
            if (object instanceof Float) {
                stringBuilder.append(conversionSpecification.internalsprintf(((Float)object).floatValue()));
                continue;
            }
            if (object instanceof Double) {
                stringBuilder.append(conversionSpecification.internalsprintf((Double)object));
                continue;
            }
            if (object instanceof Character) {
                stringBuilder.append(conversionSpecification.internalsprintf(((Character)object).charValue()));
                continue;
            }
            if (object instanceof String) {
                stringBuilder.append(conversionSpecification.internalsprintf((String)object));
                continue;
            }
            stringBuilder.append(conversionSpecification.internalsprintf(object));
        }
        return stringBuilder.toString();
    }
