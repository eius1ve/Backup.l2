...
public class LabyrinthLostBeholder
extends Fighter {
    public LabyrinthLostBeholder(NpcInstance npcInstance) {
        super(npcInstance);
    }
    ...
    protected void onEvtDead(Creature creature) {
        ...
        if (!reflection.isDefault() && this.a(npcInstance.getNpcId()) && this.a() != null) {
            this.a().addStatFunc((Func)new FuncSet(Stats.MAGIC_DEFENCE, 48, (Object)this, (double)this.a().getTemplate().baseMDef * 0.66));
        }
