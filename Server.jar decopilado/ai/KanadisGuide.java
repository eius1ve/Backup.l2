...
public class KanadisGuide
extends Fighter {
    public KanadisGuide(NpcInstance npcInstance) {
        super(npcInstance);
    }
    ...
    protected void onEvtSpawn() {
        ...
        List list = npcInstance.getAroundNpc(5000, 300);
        if (list != null && !list.isEmpty()) {
            for (NpcInstance npcInstance2 : list) {
                if (npcInstance2.getNpcId() != 36562) continue;
                npcInstance.getAI().notifyEvent(CtrlEvent.EVT_ATTACKED, (Object)npcInstance2, (Object)5000);
            }
        }
    }
