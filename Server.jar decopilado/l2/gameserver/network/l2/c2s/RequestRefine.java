...
extends L2GameClientPacket {
    private static final int rT = 2130;
    private static final int rU = 2131;
    private static final int rV = 2132;
    private int qz;
    private int qA;
    private int qB;
    private long cR;
    ...
    protected void runImpl() {
        ...
        iRefineryHandler.onRequestRefine(player, itemInstance, itemInstance2, itemInstance3, this.cR);
    }
}
