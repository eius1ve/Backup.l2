...
public class _201_HfighterTutorial
extends Quest
implements ScriptFile {
    private static final int VQ = 30008;
    private static final int VR = 30009;
    private static final int VS = 18342;
    private static final int VT = 1067;
    private static final int VU = 6353;
    private static final int VV = 5789;
    private static final int VW = 5790;
    private static final int VX = 0;
    private static final int VY = 49;
    private static final int VZ = 0x100000;

    public _201_HfighterTutorial() {
        super(0);
        this.addTalkId(new int[]{30009, 30008});
        this.addFirstTalkId(new int[]{30009, 30008});
    ...
    public String onEvent(String string, QuestState questState, NpcInstance npcInstance) {
        ...
        if (string.equalsIgnoreCase("timer_newbie_helper")) {
            ...
            if (n == 3) {
                questState.playTutorialVoice("tutorial_voice_010a");
            }
            return null;
        }
        ...
        if (string.equalsIgnoreCase("reply_31") && questState.getQuestItemsCount(1067) > 0L) {
            ...
            string2 = "roien002.htm";
            questState.takeItems(1067, -1L);
    ...
    public String onFirstTalk(NpcInstance npcInstance, Player player) {
        ...
        if (questState2 == null) {
            ...
            questState2 = player.getQuestState(_201_HfighterTutorial.class);
        }
        int n2 = questState2.getPlayer().getClassId().getId();
        int n3 = questState2.getPlayer().getClassId().level();
        int n4 = questState.getInt("tutorial_quest_ex");
        int n5 = questState.getInt("tutorial_quest");
        switch (n) {
            case 30009: {
                int n6 = n5 & 0x7FFFFF00;
                if (n4 < 0) {
                    if (n2 == 0 && player.getRace() == Race.human) {
                        questState2.startQuestTimer("timer_newbie_helper", 30000L);
                        string = "carl001.htm";
                        questState.set("tutorial_quest_ex", "0");
                        questState.onTutorialClientEvent(n6 | 0x100000);
                        break;
                    }
                    string = "carl006.htm";
                    break;
                }
                if ((n4 == 1 || n4 == 2 || n4 == 0) && questState2.getQuestItemsCount(6353) < 1L) {
                    string = "carl002.htm";
                    break;
                }
                if ((n4 == 1 || n4 == 2 || n4 == 0) && questState2.getQuestItemsCount(6353) > 0L) {
                    string = "carl003.htm";
                    questState2.takeItems(6353, -1L);
                    questState.set("tutorial_quest_ex", String.valueOf(3), true);
                    questState2.giveItems(1067, 1L);
                    questState2.startQuestTimer("timer_newbie_helper", 30000L);
                    questState.set("tutorial_quest", String.valueOf(n6 | 4), true);
                    if (n3 == 0 && questState2.getQuestItemsCount(5789) <= 0L) {
                        questState2.giveItems(5789, 200L);
                        questState2.playTutorialVoice("tutorial_voice_026");
                    }
                    if (!bl || questState2.getQuestItemsCount(5789) > 0L || questState2.getQuestItemsCount(5790) > 0L) break;
                    if (n2 == 49) {
                        questState2.playTutorialVoice("tutorial_voice_026");
                        questState2.giveItems(5789, 200L);
                        break;
                    ...
                    questState2.giveItems(5790, 200L);
                    break;
                }
                if (n4 == 3) {
                    string = "carl004.htm";
            ...
            case 30008: {
                if (questState2.getQuestItemsCount(1067) > 0L) {
                    string = "roien001.htm";
                    break;
                }
                if (questState2.getQuestItemsCount(1067) == 0L && n4 > 3) {
                    string = "roien004.htm";
                    break;
                }
                if (questState2.getQuestItemsCount(1067) != 0L || n4 > 3) break;
                string = "roien003.htm";
            }
        }
        return string;
