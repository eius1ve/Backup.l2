...
public class _073_SagaOfTheDuelist
...
implements ScriptFile {
    ...
    public _073_SagaOfTheDuelist() {
        super(1);
        this.NPC = new int[]{30849, 31624, 31226, 31331, 31639, 31646, 31647, 31653, 31654, 31655, 31656, 31277, 31537};
        ...
        this.Y = new int[]{-76504, -56923, -56929};
