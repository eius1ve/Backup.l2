...
public class IpLimitedZone
implements ScriptFile {
    private static final Logger eC = LoggerFactory.getLogger(IpLimitedZone.class);
    private static final String iU = "uniqIpLimit";
    private static final String iV = "uniqIpBackLoc";

    public void onLoad() {
        int n = 0;
        Collection collection = ReflectionManager.DEFAULT.getZones();
        for (Zone zone : collection) {
            final int n2 = zone.getParams().getInteger((Object)iU, 0);
            if (n2 <= 0) continue;
            String string = zone.getParams().getString((Object)iV, null);
            ...
            OnZoneEnterLeaveListener onZoneEnterLeaveListener = new OnZoneEnterLeaveListener(){
                ...
                public void onZoneEnter(Zone zone, Creature creature) {
                    ...
                    for (Player player2 : zone.getInsidePlayers()) {
                        ...
                        if (player2 == null || player2 == player || (gameClient2 = player2.getNetConnection()) == null || StringUtils.isBlank((CharSequence)(string2 = gameClient2.getIpAddr())) || !StringUtils.equals((CharSequence)string, (CharSequence)string2) || ++n <= n2) continue;
        ...
        if (n > 0) {
            eC.info("IpLimitedZone: added {} uniq IP zone(s).", (Object)n);
        }
    }
