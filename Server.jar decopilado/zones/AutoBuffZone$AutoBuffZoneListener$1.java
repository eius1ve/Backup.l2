...
class AutoBuffZone.AutoBuffZoneListener.1
extends RunnableImpl {
    final /* synthetic */ HardReference val$playerRef;

    AutoBuffZone.AutoBuffZoneListener.1(HardReference hardReference) {
    ...
    public void runImpl() throws Exception {
        ...
        for (Pair<Skill, Integer> pair : AutoBuffZoneListener.this.ea) {
