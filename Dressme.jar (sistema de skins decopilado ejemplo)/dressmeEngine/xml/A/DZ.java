...
extends AbstractFileParser<DressMeShieldHolder> {
    private final String B = Config.DATAPACK_ROOT + "/data/xml/wardrobe/dressme/shield.xml";
    ...
    private DZ() {
        super((AbstractHolder)DressMeShieldHolder.getInstance());
    }
            ...
            while (firstChild != null) {
                if (firstChild.getNodeName().equalsIgnoreCase("list")) {
                    ...
                    while (firstChild2 != null) {
                        if (firstChild2.getNodeName().equalsIgnoreCase("shield")) {
                            A a;
                            ...
                            Node namedItem = firstChild2.getAttributes().getNamedItem("isShield");
                            ...
                            ((DressMeShieldHolder)this.getHolder()).addShield(new DressMeShieldData(parseInt, parseInt2, nodeValue, i, j, valueOf, a));
                        }
