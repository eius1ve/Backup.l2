...
extends AbstractFileParser<DressMeHatHolder> {
    private final String B = Config.DATAPACK_ROOT + "/data/xml/wardrobe/dressme/hat.xml";
    ...
    private BZ() {
        super((AbstractHolder)DressMeHatHolder.getInstance());
    }
            ...
            while (firstChild != null) {
                if (firstChild.getNodeName().equalsIgnoreCase("list")) {
                    ...
                    while (firstChild2 != null) {
                        if (firstChild2.getNodeName().equalsIgnoreCase("hat")) {
                            A a;
                            ...
                            int parseInt3 = Integer.parseInt(firstChild2.getAttributes().getNamedItem("slot").getNodeValue());
                            int i = 0;
                            long j = 0L;
                            ...
                            ((DressMeHatHolder)this.getHolder()).addHat(new DressMeHatData(parseInt, parseInt2, nodeValue, parseInt3, i, j, a));
                        }
